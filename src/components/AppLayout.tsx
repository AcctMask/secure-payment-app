...
export const AppLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950">
      ...
      {/* Hero Section with Test Flow Panel */}
      ...
      <section className="py-16 px-6 bg-slate-900/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-2">System Readiness Check</h2>
            <p className="text-gray-400">Verify your environment is configured for live transactions</p>
          </div>
          <DiagnosticPanel />
        </div>
      </section>

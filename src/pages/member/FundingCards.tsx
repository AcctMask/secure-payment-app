  ...
  return (
    <Card className="bg-black/20 border-white/10">
      <CardContent className="p-6 space-y-4">
        <h2 className="text-lg font-medium">Add a Funding Card</h2>
...
const FundingCardsPage: React.FC = () => {
  ...
  const onSaved = (row: FundingCardRow) => {
    ...
    setMsg("✅ Funding card saved. Next: issue your first virtual card.");
  };
      ...
      <div className="px-6 py-10 max-w-4xl mx-auto text-white space-y-8">
        ...
        <Card className="bg-black/20 border-white/10">
          <CardContent className="p-6">
            <h2 className="text-lg font-medium mb-3">Saved Funding Cards (this session)</h2>
